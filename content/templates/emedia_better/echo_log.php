...
<div class="wrapper clearfix pt10">
  <div class="con-left">
    ...
    <p class="icogroup lh180 loginfo"><span class="ico-list"><span class="icon icon-01"></span>发布：<?php blog_author($author); ?></span><span class="ico-list"><span class="icon icon-02"></span><?php echo gmdate('Y-n-j G:i', $date); ?></span><span class="ico-list"><span class="icon icon-03"></span>分类：<?php blog_sort($logid); ?></span><span class="ico-list"><?php blog_tag($logid); ?></span> <?php editflg($logid,$author); ?></p>
...
<?php echo $log_content; ?>
    ...
    <div class="logbtad mb15"><?php echo _g('logad'); ?></div>
    <div class="link-box">
      <h3>相关文章</h3>
      <ul class="ullist4">
	  	  <?php get_list($sortid); ?>
